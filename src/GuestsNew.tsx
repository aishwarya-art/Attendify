...
import { FaCheck, FaTimes, FaArrowLeft, FaHome, FaPowerOff,FaChevronRight, FaChevronLeft, FaBell } from 'react-icons/fa';
...
const GuestsNew: React.FC = () => {
  ...
  return (
    <View style={styles.containernew}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
      onPress={handlePreviousPageCaptured}
      disabled={currentPageCaptured === 0}
      style={currentPageCaptured === 0 ? styles.disabledButton : styles.buttonPagination}
    >
      <FaChevronLeft style={currentPageCaptured === 0 ? styles.iconDisabled : styles.iconEnabled} />
    </TouchableOpacity>
    <TouchableOpacity
      onPress={handleNextPageCaptured}
      disabled={(currentPageCaptured + 1) * itemsPerPage >= filteredCapturedVisitors.length}
      style={(currentPageCaptured + 1) * itemsPerPage >= filteredCapturedVisitors.length ? styles.disabledButton : styles.buttonPagination}
    >
      <FaChevronRight style={(currentPageCaptured + 1) * itemsPerPage >= filteredCapturedVisitors.length ? styles.iconDisabled : styles.iconEnabled} />
    </TouchableOpacity>
    </View>
        <Text style={{ marginTop: 0, marginBottom: 0 }}>Identified Visitors</Text>
 ...
 <View style={styles.buttonsContainer}>
    ...
    >
      <Text style={currentPage === 0 ? styles.iconDisabled : styles.iconEnabled}>
      <FaChevronLeft/>
      </Text>
    </TouchableOpacity>
    <TouchableOpacity
    ...
    >
      <Text style={(currentPage + 1) * itemsPerPage >= data.length ? styles.iconDisabled : styles.iconEnabled}>
      <FaChevronRight/>
      </Text>
    </TouchableOpacity>
  </View>
        <Text style={{ marginTop: 0, marginBottom: 0 }}>Trusted Visitors</Text>
        {currentTrustedData.length > 0 ? (
          <FlatList
...
<View style={styles.buttonsContainer}>
    <TouchableOpacity
      onPress={handlePreviousPageTrusted}
      disabled={currentPageTrusted === 0}
      style={currentPageTrusted === 0 ? styles.disabledButton : styles.buttonPagination}
    >
      <Text style={currentPageTrusted === 0 ? styles.iconDisabled : styles.iconEnabled}>
      <FaChevronLeft/>
      </Text>
    </TouchableOpacity>
    <TouchableOpacity
      onPress={handleNextPageTrusted}
      disabled={(currentPageTrusted + 1) * itemsPerPagethree >= filteredTrustedVisitors.length}
      style={(currentPageTrusted + 1) * itemsPerPagethree >= filteredTrustedVisitors.length ? styles.disabledButton : styles.buttonPagination}
    >
      <Text style={(currentPageTrusted + 1) * itemsPerPagethree >= filteredTrustedVisitors.length ? styles.iconDisabled : styles.iconEnabled}>
      <FaChevronRight/>
      </Text>
    </TouchableOpacity>
  </View>
        ...
        <Navigation />
          <View style={styles.modalContainer}>
            ...
            <Text style={{ marginTop: 20, marginBottom: 0 }}>Visitor History</Text>
            <FlatList
              data={records}
          ...
          <div className="footer">
            <FaArrowLeft className="footer-icon" onClick={handleLeftArrowClick} />
